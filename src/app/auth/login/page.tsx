...
import { Loader2, AlertCircle, Eye, EyeOff, Shield, Building, User } from "lucide-react";
...
export default function LoginPage() {
  ...
  const { register, handleSubmit, setError, setValue, formState: { errors, isSubmitting } } = useForm<LoginInput>({
